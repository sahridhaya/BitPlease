...
#for controlling pins in raspberry pi
...
def setServoAngle(servo, angle):
  #  assert angle >=30 and angle <= 150
    ...
    sleep(0.3)
    pwm.stop()
#switch function if switch is being used
def switch1():
...
def execute(l):
    ...
    print(predictions)
    # Display the prediction during debugging
    ...
    if (predictions[0,0]==1):
        ...
        return l
while(True):
    #switch1() if we are using switch
    setServoAngle(pan, 0)
