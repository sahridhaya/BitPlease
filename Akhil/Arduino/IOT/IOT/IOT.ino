...
#define WLAN_SSID       "Nokkanda Tharoola"
#define WLAN_PASS       "ParayulA"
char watt[5];
#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883                   
#define AIO_USERNAME    "Akhil_newton"
#define AIO_KEY         "39b3edb75a5d4d1b8d86d3a5b960ad13"
WiFiClient client;
int bill_amount = 0;   
...
if (bill_amount>=4 && bill_amount<5){
for (int i =0; i<=2; i++)
{
